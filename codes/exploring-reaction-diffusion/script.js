...
function onWindowResize(event) {
  ...
  rtTexture = new THREE.WebGLRenderTarget(texSize, texSize);
  rtTexture2 = new THREE.WebGLRenderTarget(texSize, texSize);
  rtTexture.texture.wrapS = THREE.RepeatWrapping;
  rtTexture.texture.wrapT = THREE.RepeatWrapping;
  // rtTexture.texture.minFilter = THREE.NearestFilter;
  // rtTexture.texture.magFilter = THREE.NearestFilter;
  rtTexture2.texture.wrapS = THREE.RepeatWrapping;
  rtTexture2.texture.wrapT = THREE.RepeatWrapping;
  // rtTexture2.texture.minFilter = THREE.NearestFilter;
  // rtTexture2.texture.magFilter = THREE.NearestFilter;
}
...
function renderTexture(delta) {
  ...
  uniforms.u_resolution.value.x = texSize;
  uniforms.u_resolution.value.y = texSize;
