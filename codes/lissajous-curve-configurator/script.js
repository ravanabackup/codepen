...
class Dial {
  constructor(options) {_defineProperty(this, "update",
    ...
    () => {
      ...
      return { x, y };
    });this.ROTATION = 90;this.SPEED = options.speed;this.RADIUS = options.radius;this.CLOCKWISE = options.clockwise;this.CANVAS = document.createElement('canvas');this.CANVAS.width = this.CANVAS.height = UNIT;this.CONTEXT = this.CANVAS.getContext('2d');return this;}}
