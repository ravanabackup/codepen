function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const woodTexture = "https://assets.codepen.io/163598/texture3.jpg";
const stoneTexture = "https://assets.codepen.io/163598/texture13.jpg";
...
let umouse = [gl.canvas.width * 0.5, gl.canvas.height * 0.5, 0, 1];
let tmouse = umouse;
// RENDER LOOP
const render = time => {
