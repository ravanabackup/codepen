function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const woodTexture = "https://assets.codepen.io/163598/texture2.jpg";
const stoneTexture = "https://assets.codepen.io/163598/texture3.jpg";
...
const loadTexture = imageList => {
  ...
  Promise.all(promises).then(images => {
    ...
    texts = twgl.createTextures(gl, {
      iChannel1: txtImages[0],
      iChannel2: txtImages[1] });

    let uniforms = {
      iChannel1: texts.iChannel1,
      iChannel2: texts.iChannel2 };
