...
var w2 = c2.width = 100;
var h2 = c2.height = 100;
var $2 = c2.getContext("2d");
var gradCache = $2.createRadialGradient(
        w2 / 2,
        h2 / 2,
        0,
        w2 / 2,
...
gradCache.addColorStop(0, 'hsla(218, 95%, 85%, 1)');
gradCache.addColorStop(1, 'hsla(218, 100%,85%,0.1)');
$2.fillStyle = gradCache;
$2.beginPath();
$2.arc(w2 / 2, h2 / 2, w2 / 2, 0, Math.PI * 2);
$2.fill();
  ...
  Obj.prototype.draw = function() {
    ...
    for (var i = 0; i < this.v.length; i++) {
      ...
      */
      ...
      // draw the cached gradient canvas as an image
      this.$.drawImage( c2, this.v[i].transOut.x - this.v[i].transOut.p * 2, this.v[i].transOut.y - this.v[i].transOut.p * 2, this.v[i].transOut.p * 4, this.v[i].transOut.p * 4);
