...
THEME = ['#fafe92', '#ffb066', '#ff9191', '#e679c8', '#974bb5'],
NT = THEME.length,
...
class RandPoly {
  constructor(i, j) {
    ...
    this.f = 3; /* frequency */
    this.δ = Math.round(Math.atan2(this.oy, this.ox) * 180 / Math.PI + Math.hypot(this.ox, this.oy) / Math.abs(O) * 360); /* initial angular offset of pulse */
